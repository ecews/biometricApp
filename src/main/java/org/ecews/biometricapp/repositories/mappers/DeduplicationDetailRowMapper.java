...
public class DeduplicationDetailRowMapper implements RowMapper<DeduplicationDetail> {
    ...
    public DeduplicationDetail mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        result.setEnrolledDateOfBirth(rs.getDate("enrolled_date_of_birth").toLocalDate());
        ...
        result.setEnrolledArtStartDate(rs.getDate("enrolled_art_start_date").toLocalDate());
        ...
        result.setMatchedDateOfBirth(rs.getDate("matched_date_of_birth").toLocalDate());
        ...
        result.setMatchedArtStartDate(rs.getDate("matched_art_start_date").toLocalDate());
        ...
        result.setDateOfDeduplication(rs.getDate("date_of_deduplication").toLocalDate());
